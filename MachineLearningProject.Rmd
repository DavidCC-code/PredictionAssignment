...
Due to the data set many freatures and the, a priori, lack of knowledge about the weight of each of them in the classification, we will train two models that can work well with classifications and can  manage that situation, gradient boosting model and random forest, later we will see which is more accurate using the validation dataset.
