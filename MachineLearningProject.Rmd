...
## Remove "X", "user_name", "raw_timestamp_part_1", "raw_timestamp_part_2", "cvtd_timestamp", "new_window", "num_window",  7 first columns
...
As shown by the confusion matrixes  gradient boosting model's accuracy is 96% and random forets' is over 99% which is a very good result and a out of sample error of 0.004%
